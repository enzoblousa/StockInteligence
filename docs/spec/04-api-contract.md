...
Status: **Rascunho** · Última revisão: 2026-08-18
...
| Situação | HTTP | `type` |
|---|---|---|
| Estoque insuficiente ao confirmar venda | 422 | `urn:stockpilot:insufficient-stock` |
| Conflito de concorrência (versão de estoque) | 409 | `urn:stockpilot:stock-conflict` |
| Transição de status inválida (ex: receber pedido cancelado) | 409 | `urn:stockpilot:invalid-transition` |
| Documento (CPF/CNPJ) ou SKU duplicado | 409 | `urn:stockpilot:duplicate-key` |
| Validação de campo (Bean Validation) | 400 | `urn:stockpilot:validation-error` |
